...
public class InfoViewController {
    ...
    public void initialize() {
    	...
    	this.cookedDishesName.setText(name);
    	this.cookedDishesImage.setImage(image);
    	this.cookedDisheshunger.setText(String.valueOf(hunger));
    	this.cookedDishesHealth.setText(String.valueOf(health));
    	this.cookedDishesSanity.setText(String.valueOf(sanity));
    	this.qualityTime.setText(String.valueOf(qualityTime));
    	this.cookTime.setText(String.valueOf(cookTime));
    	this.buff.setText(buff);
    	this.comment.setText(comment);
      
        ObservableList<CLBean> clDataList = new InfoService().getInfoData(name);
        
        if(clDataList.get(0) != null){CLBean clBean1 = clDataList.get(0); 
...
//        if(clDataList.get(1) != null){
//        	CLBean clBean2 = clDataList.get(1);
//        	VBox vbox5 = new VBox();
...
//        
//        }
//        if(clDataList.get(2) != null){CLBean clBean3 = clDataList.get(2); 
//        VBox vbox9 = new VBox();
...
//        }
//        
//        if(clDataList.get(3) != null){CLBean clBean4 = clDataList.get(3);
//        
